...
|---------|--------|-------------|
| id      | string | CIF/CUI of the company (digits, no RO prefix) |
...
| Field        | Type     | Description |
|--------------|----------|-------------|
| brand        | string   | Commercial brand name (e.g. "SOBIS AP") |
...
- **scraperFile**: Full URL to GitHub raw workflow YML (e.g. `https://raw.githubusercontent.com/sebiboga/sobis-ap-srl-nodejs-scraper/main/.github/workflows/job-seeker-ro-spider.yml`)
